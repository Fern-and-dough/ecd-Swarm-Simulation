...
[crossZ,pentZ] = GenerateZ(Formation,Center,crossXY,pentXY,BEAM_DIRECTION,FREQUENCY,NUM_DRONES);
...
if(Offset == "Cross")
    [offset_pos, offset_field] = OffsetFarField(crossXY, crossZ, MAX_ERROR_ALLOWED, FREQUENCY, NUM_DRONES);
end
